...
export const CommentCreateForm = ({replyId, setReplyId, comments, setComments, userNameReplyTo, setUserNameReplyTo}) => {
    ...
    const handleSubmit = (e) => {
        ...
        try {
            ...
            if(isCaptchaCorrect) {
                ...
                axios.post(`${import.meta.env.VITE_BACKEND_HOST}/api/createComment`, commentData)
                    .then((response)=>{
    ...
    */
    const handlePreview = () => {
        ...
        axios.post(`${import.meta.env.VITE_BACKEND_HOST}/api/createPreviewComment`, commentPreviewData)
            .then((response)=>{
                if(response.data.message){
                    setErrorMessage(response.data.message);
                    return;
