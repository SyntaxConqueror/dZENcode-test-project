...
export const CommentsThread = ({setReplyId, comments, setComments, setUserNameReplyTo}) => {
    ...
    const handleOptionSelect = (option) => {
        const sortEndpoints = {
            'ascending': `${import.meta.env.VITE_BACKEND_HOST}/api/dateAscendingSort`,
            'descending': `${import.meta.env.VITE_BACKEND_HOST}/api/dateDescendingSort`,
            'username': `${import.meta.env.VITE_BACKEND_HOST}/api/usernameSort`,
            'email': `${import.meta.env.VITE_BACKEND_HOST}/api/emailSort`,
        }
        setComments([]);
    ...
    return (
        ...
        <div className={styles.loading__gif}>
            <span>Loading</span>
            <img src="https://dzencode-test-s3-bucket.s3.eu-central-1.amazonaws.com/site-usings/loading.gif" width={20} height={20} alt="Loading..." />
        </div>
    )
}