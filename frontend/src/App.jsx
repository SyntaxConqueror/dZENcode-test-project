...
function App() {
    ...
    useEffect(()=>{
        if(!cacheStatus){
            const sortEndpoints = [
                'http://127.0.0.1:8000/api/dateDescendingSort',
                'http://127.0.0.1:8000/api/dateAscendingSort',
                'http://127.0.0.1:8000/api/usernameSort',
                'http://127.0.0.1:8000/api/emailSort',
            ]
